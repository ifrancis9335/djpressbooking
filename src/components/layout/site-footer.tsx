...
import { packageTiers, siteContact } from "../../data/catalog";
  ...
  return (
    <footer className="footer-shell">
      <div className="container-width grid gap-8 py-12 md:grid-cols-2 lg:grid-cols-4">
        <div>
          <p className="section-kicker border-luxeGold/45 bg-luxeGold/10 text-amber-100">{siteContact.serviceArea}</p>
          ...
          <p className="mt-1 text-sm text-slate-300">{siteContact.phone}</p>
        ...
        <div>
          ...
          <div className="mt-3 flex flex-wrap gap-3 text-sm text-slate-300">
            ...
            <Link className="footer-link font-semibold text-luxeGold" href="/booking">Book Now</Link>
          </div>
