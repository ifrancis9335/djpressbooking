...
function maskEmail(email: string) {
  ...
  if (!localPart || !domainPart || localPart.length < 3) {
    return email;
  }
      ...
      <div className="page-container">
        <div className="container-width grid gap-5">
          <section className="glass-panel p-5 md:p-6">
            ...
            <p className="mt-2 text-slate-300">Email verified: {maskEmail(verified.email)}</p>
                ...
                return (
                  <article key={item.booking.id} className="glass-panel p-5 md:p-6">
                    <div className="grid gap-3 md:grid-cols-2 lg:grid-cols-3">
                      <p className="text-slate-300"><span className="font-semibold text-white">Booking Reference:</span> {maskBookingId(item.booking.id)}</p>
