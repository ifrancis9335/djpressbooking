...
import { getGalleryItems, getReviewItems } from "../../lib/content-items";
...
export default async function ReviewsPage() {
  ...
  const featured = reviewItems.find((item) => item.featured) ?? reviewItems[0];
  ...
  return (
    <main className="section-shell">
      <div className="container-width">
        ...
        <h1 className="text-3xl font-bold text-white md:text-4xl">{siteContent.reviewsIntro.title}</h1>
        <p className="mt-3 max-w-3xl text-slate-300">{siteContent.reviewsIntro.description}</p>
